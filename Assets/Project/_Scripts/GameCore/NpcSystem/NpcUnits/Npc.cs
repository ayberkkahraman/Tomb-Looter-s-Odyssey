using Project._Scripts.GameCore.NpcSystem.NpcUnits.Base;
...
namespace Project._Scripts.GameCore.NpcSystem.NpcUnits
{
  public class Npc : NpcBase
  {
    ...
    public void Interact()
    {
      ...
      ManagerCore.Instance.GetInstance<DialogueManager>().OnDialogueStartHandler(CurrentDialogue.DialogueData);
    }
