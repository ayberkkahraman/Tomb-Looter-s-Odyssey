...
namespace Project._Scripts.GameCore.InteractionSystem.Interactables.Collectibles.Base
{
  public abstract class CollectableBase : MonoBehaviour
  {
    ...
    // /// </summary>
    // protected virtual void PlayAudioOnCollect() => ManagerCore.Instance.GetInstance<AudioManager>().PlayAudio(AudioName);
